...
if __name__ == '__main__':
    # 读取相机内参
    with np.load('checkerboard.npz') as X:
        mtx, dist = [X[i] for i in ('mtx', 'dist')]
        print(mtx, '\n', dist)
    photo_path = "../images/Image_20210507134320083.bmp"  # 标定图像保存路径
...
"""旋转矩阵和平移矩阵组成的其次矩阵"""
"""
[[ 8.57884995e-01  3.03465872e-01 -4.14658655e-01 -1.01798435e+02]
 [-2.95153473e-01  9.51591748e-01  8.57762962e-02 -3.35895861e+01]
 [ 4.20615933e-01  4.88017448e-02  9.05925288e-01  3.58246429e+02]
